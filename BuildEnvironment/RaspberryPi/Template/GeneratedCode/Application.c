...
void ApplicationTemperature_onEvent( ApplicationTemperature _this, XObject sender )
{
  ...
  ViewsText_OnSetString( &_this->Text, EwConcatString( EwNewStringFloat( EwGetAutoObject( 
  &DeviceDevice, DeviceDeviceClass )->Temperature, 0, 6 ), EwLoadString( &_Const0097 
  )));
}
