...
#ifndef _ApplicationWellPart_H
#define _ApplicationWellPart_H
...
/* Forward declaration of the class Application::WellPart */
#ifndef _ApplicationWellPart_
  EW_DECLARE_CLASS( ApplicationWellPart )
#define _ApplicationWellPart_
#endif
...
/* Deklaration of class : 'Application::WellPart' */
EW_DEFINE_FIELDS( ApplicationWellPart, CoreGroup )
  EW_OBJECT  ( WarpImage,       ViewsWarpImage )
  EW_OBJECT  ( Text,            ViewsText )
  EW_PROPERTY( TimeProperty,    XString )
  EW_PROPERTY( CircuitNumber,   XInt32 )
EW_END_OF_FIELDS( ApplicationWellPart )

/* Virtual Method Table (VMT) for the class : 'Application::WellPart' */
EW_DEFINE_METHODS( ApplicationWellPart, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationWellPart _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationWellPart _this, XSet aState )
  EW_METHOD( InvalidateArea,    void )( CoreGroup _this, XRect aArea )
  EW_METHOD( Restack,           void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationWellPart )
