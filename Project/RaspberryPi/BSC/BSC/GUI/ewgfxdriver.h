...
*   native, index8 or alpha8 surface to a screen or native surface. The copied
*   pixel can optionally be modulated by solid or gradient color/opacity values.
*
* ARGUMENTS:
*   aDstHandle  - Handle to the screen/native destination surface.
...
*   copied pixel can be modulated by solid or gradient color/opacity values.
*
* ARGUMENTS:
*   aDstHandle  - Handle to the screen/native destination surface.
*   aSrcHandle  - Handle to the native/index8/alpha8 source surface.
...
*   from native, index8 or alpha8 surface to a screen or native surface. The
