...
*
*   > 4 bitmap formats: Index8, Alpha8, Native and Screen. The Graphics Engine
*     provides a rich set of drawing operations with bitmaps as a destination
*     and source. Bitmaps can be copied, alpha-blended or even perspective
