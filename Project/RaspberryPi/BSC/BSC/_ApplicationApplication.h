...
EW_DEFINE_FIELDS( ApplicationApplication, CoreRoot )
  ...
  EW_OBJECT  ( ButtonMenu1,     FlatToggleButton )
  EW_OBJECT  ( Button1,         XFlatIconButton )
  EW_OBJECT  ( ButtonMenu2,     FlatToggleButton )
  EW_OBJECT  ( Button2,         XFlatIconButton )
  EW_OBJECT  ( BarRemainingTime, FlatHorzBar )
  EW_OBJECT  ( Timer,           CoreTimer )
  EW_OBJECT  ( Start,           FlatActionButton )
  EW_OBJECT  ( HorzSlider,      FlatHorzSlider )
  EW_OBJECT  ( TimerMinuten,    CoreTimer )
  EW_OBJECT  ( Stop,            FlatActionButton )
