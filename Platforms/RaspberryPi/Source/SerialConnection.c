...
//	options.c_cflag = B256000 | CS8 | CLOCAL | CREAD;		//<Set baud rate
...
//	if (aStream != -1)
//	{
//		int count = write(aStream, aCharArra, aLength);		//Filestream, bytes to write, number of bytes to write
//		if (count < 0)
//		{
...
//		int rx_length = read(aStream, (void*)rx_buffer, 255);		//Filestream, buffer to store in, number of bytes to read (max)
//		if (rx_length < 0)
//		{
